...
/**2. Write a java program to input student Name, roll No, and three subjects Math, Science and  English marks
...
public class Program_2 {
    ...
    public static void main(String[] args) {
        ...
        while (science > 100 || science < 0) {
            System.out.println("Invalid Input, Science marks should be between 0 100");
